...
export function FlowerIcon({ size = 24, className = '', style }: { size?: number; className?: string; style?: CSSProperties }) {
    return (
        <svg
            width={size}
            height={size}
            ...
            style={style}
        >
            <path d="M9.65 8.76 A4 4 0 1 1 14.35 8.76 A4 4 0 1 1 15.8 13.24 A4 4 0 1 1 12 16 A4 4 0 1 1 8.2 13.24 A4 4 0 1 1 9.65 8.76Z" />
            <circle cx="12" cy="12" r="2.5" />
        </svg>
    )
}

export function SearchIcon({ size = 18, className = '', style }: { size?: number; className?: string; style?: CSSProperties }) {
    return (
...
export function HeartIcon({ size = 16, filled = false, className = '' }: { size?: number; filled?: boolean; className?: string }) {
    return (
...
export function KeyIcon({ size = 16, className = '', style }: { size?: number; className?: string; style?: CSSProperties }) {
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
...
export function CloseIcon({ size = 18, className = '', style }: { size?: number; className?: string; style?: CSSProperties }) {
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
